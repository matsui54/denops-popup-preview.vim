...
execute join(['function! vital#_popup_preview#VS#Vim#Syntax#Markdown#import() abort', printf("return map({'apply': ''}, \"vital#_popup_preview#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
"
" apply
